...
/****************************
Name of task: arrays_continued.js
****************************/
...
function getChocInput() {
  ...
  if (chocInput <= 0) {
    OUTPUT.innerHTML += "<p>You Loathe Chocolate.</p>";
  } else if (chocInput >= 1 && chocInput <= 3) {
...
const U_ITEM = document.getElementById("Uitem");

let itemArray = ["juice", "bread", "water", "chips"];
function getFormInput() {
    let choice = U_ITEM.value;
